...
func (c *usercenterClient) UserList(ctx context.Context, in *UserListReq, opts ...grpc.CallOption) (*UserListResp, error) {
	out := new(UserListResp)
	err := c.cc.Invoke(ctx, "/pb.usercenter/userList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usercenterClient) QueryFollowsByFollowUserID(ctx context.Context, in *QueryFollowsByFollowUserIDRequest, opts ...grpc.CallOption) (*QueryFollowsByFollowUserIDResponse, error) {
	out := new(QueryFollowsByFollowUserIDResponse)
	err := c.cc.Invoke(ctx, "/pb.usercenter/QueryFollowsByFollowUserID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsercenterServer interface {
	...
	QueryFollowsByFollowUserID(context.Context, *QueryFollowsByFollowUserIDRequest) (*QueryFollowsByFollowUserIDResponse, error)
...
func (UnimplementedUsercenterServer) UserList(context.Context, *UserListReq) (*UserListResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserList not implemented")
}
func (UnimplementedUsercenterServer) QueryFollowsByFollowUserID(context.Context, *QueryFollowsByFollowUserIDRequest) (*QueryFollowsByFollowUserIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryFollowsByFollowUserID not implemented")
}
...
func _Usercenter_UserList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.usercenter/userList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).UserList(ctx, req.(*UserListReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Usercenter_QueryFollowsByFollowUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryFollowsByFollowUserIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsercenterServer).QueryFollowsByFollowUserID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.usercenter/QueryFollowsByFollowUserID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).QueryFollowsByFollowUserID(ctx, req.(*QueryFollowsByFollowUserIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Usercenter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryFollowsByFollowUserID",
			Handler:    _Usercenter_QueryFollowsByFollowUserID_Handler,
		},
	},
