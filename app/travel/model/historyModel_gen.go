...
func (m *defaultHistoryModel) Delete(ctx context.Context, historyId int64) error {
	heartTripTravelHistoryIdKey := fmt.Sprintf("%s%v", cacheHeartTripTravelHistoryIdPrefix, historyId)
...
func (m *defaultHistoryModel) DeleteAll(ctx context.Context, userId int64) error {
	heartTripTravelHistoryIdKey := fmt.Sprintf("%s%v", cacheHeartTripTravelHistoryIdPrefix, userId)
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
...
func (m *defaultHistoryModel) FindOneByHomestayIdAndUserId(ctx context.Context, homestayId, userId int64) (*History, error) {
	//heartTripTravelHistoryIdKey := fmt.Sprintf("%s%v%v", cacheHeartTripTravelHistoryIdPrefix, homestayId, userId)
	var resp History
