...
(
    ...
    banner_urls          varchar(4096) default ''                not null,
    title_tags           varchar(1024) default ''                not null,
    comment_count        bigint        default 0                 not null,
    location             varchar(255)  default ''                not null comment '位置',
    latitude             varchar(255)  default ''                not null,
    longitude            varchar(255)  default ''                not null,
    facilities           varchar(255)  default ''                not null,
    cover                varchar(255)  default ''                not null comment '轮播图，第一张封面',
    area                 varchar(255)  default ''                not null,
    room_config          varchar(255)  default ''                not null comment '介绍',
    clean_video          varchar(255)  default ''                not null,
    homestay_business_id bigint        default 0                 not null comment '民宿店铺id',
    host_id              bigint        default 0                 not null comment '房东id，冗余字段',
    host_avatar          varchar(255)  default ''                not null,
    host_nickname        varchar(255)  default ''                not null,
